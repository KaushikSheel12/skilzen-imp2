...
const Weoffer = () => {
  ...
  return (
    <>
      <div>
        <h1 className="text-center md:py-6 py-2 font-semibold md:text-[24px] text-[18px]">
          Content we offer{" "}
        </h1>
            ...
            >
              <div className="flex items-center gap-2 py-2 px-2">
                <div className="hidden w-12 h-12 border rounded-full md:flex justify-center  items-center bg-[#c58af2]  text-white group-hover:bg-sky-500">
                  <GrDocumentTime
                    size={20}
                    className="text-white invert-[1]"
                    color="white"
                  />
                </div>
                <h2
                  className="font-semibold md:text-gray-500 text-white  group-hover:text-white 
  ...
  text-xs md:text-[16px]"
          ...
          <div className=" px-2 py-2 rounded bg-slate-100 w-full ">
            {activeComponent}
          </div>
        </div>
      </div>
