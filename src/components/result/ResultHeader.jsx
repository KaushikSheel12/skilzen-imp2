        ...
        <div>
          <div className="flex w-[300px] h-auto gap-10 px-2 justify-around py-2">
            <button
              ...
              className="border bg-[#2FD5C8] hover:bg-black text-black hover:text-white  px-2 py-2 rounded-md"
            >
              Reattempt Test
            </button>
            <button className="border border-black px-2 py-1 rounded-md hover:bg-black hover:text-white">
              Go to Tests
            </button>
          </div>
        </div>
